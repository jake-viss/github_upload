...
print(f"There are {number_of_loans} loans in this list.")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_loans = sum(loan_costs)
print(f"The total of all the loans is {total_loans}.")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = total_loans / number_of_loans
...
new_loan_PV = calculate_present_value(new_loan["future_value"], new_loan["remaining_months"], .2)
print(f"The present value of the loan is: {new_loan_PV: .2f}")
